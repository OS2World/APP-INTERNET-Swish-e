...
pkgdatadir = $(datadir)/swish-e
pkglibdir = $(libdir)/swish-e
pkgincludedir = $(includedir)/swish-e
top_builddir = .
...
ACLOCAL = ${SHELL} k:/swishsrc/swish-e-2.4.3/config/missing --run aclocal-1.7
ALLOCA = 
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} k:/swishsrc/swish-e-2.4.3/config/missing --run tar
AR = false
AUTOCONF = ${SHELL} k:/swishsrc/swish-e-2.4.3/config/missing --run autoconf
AUTOHEADER = ${SHELL} k:/swishsrc/swish-e-2.4.3/config/missing --run autoheader
AUTOMAKE = ${SHELL} k:/swishsrc/swish-e-2.4.3/config/missing --run automake-1.7
AWK = awk.exe
BTREE_OBJS = 
BUILDDOCS_FALSE = #
BUILDDOCS_TRUE = 
...
MAKEINFO = ${SHELL} k:/swishsrc/swish-e-2.4.3/config/missing --run makeinfo
OBJEXT = o
PACKAGE = swish-e
PACKAGE_BUGREPORT = 
PACKAGE_NAME = 
...
infodir = ${prefix}/info
install_sh = k:/swishsrc/swish-e-2.4.3/config/install-sh
...
CONFIG_CLEAN_FILES = doc/Makefile rpm/swish-e.spec swish-e.pc \
	swish-config
SCRIPTS = $(bin_SCRIPTS)
...
DIST_COMMON = README $(srcdir)/Makefile.in $(srcdir)/configure INSTALL \
	Makefile.am TODO aclocal.m4 config/acinclude.m4 config/compile \
	config/config.guess config/config.sub config/depcomp \
	config/install-sh config/ltmain.sh config/missing \
	config/mkinstalldirs configure configure.in swish-config.in \
	swish-e.pc.in
...
rpm/swish-e.spec: $(top_builddir)/config.status $(top_srcdir)/rpm/swish-e.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
swish-e.pc: $(top_builddir)/config.status swish-e.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
swish-config: $(top_builddir)/config.status swish-config.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkinstalldirs) $(distdir)/. $(distdir)/config $(distdir)/debian $(distdir)/doc $(distdir)/doc/Pod $(distdir)/doc/Pod/HtmlPsPdf $(distdir)/doc/bin $(distdir)/doc/conf $(distdir)/doc/tmpl $(distdir)/perl $(distdir)/perl/t $(distdir)/pod $(distdir)/pod/images $(distdir)/rpm $(distdir)/src $(distdir)/src/vms $(distdir)/src/win32
...
installdirs-am:
	$(mkinstalldirs) $(DESTDIR)$(bindir) $(DESTDIR)$(docdir) $(DESTDIR)$(pkgconfigdir)
